...
Use the [Getting Started guide](/getting-started) to continue installing the Rig Platform, or continue with the [Rig CLI](/getting-started/cli) if you already have a Rig Platform running.
